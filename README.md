...
In this Codecademy capstone project, I built all of the routing and database logic for an internal tool for a coffee shop called Expresso.
...
I've been provided an empty **migration.js** file to write table creation logic in.
